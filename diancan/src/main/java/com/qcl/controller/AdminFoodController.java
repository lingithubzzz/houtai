...
public class AdminFoodController {
    ...
    public String export(HttpServletResponse response, ModelMap map) {
        ...
        String[] titles = {"菜品名", "单价", "库存","销量", "类目", "描述", "商品图片"};
        ...
        for (int i = 0; i < size; i++) {
            ...
            dataList[i][3] = "" + food.getFoodSales();//销量
            dataList[i][4] = "" + food.getLeimuType();//菜品类目的type
            dataList[i][5] = food.getFoodDesc();
            dataList[i][6] = food.getFoodIcon();
        }
